...
struct lua_State
{
    ...
    GarrysMod::Lua::ILua *luabase;
        ...
        #define LUA_FUNCTION_SETTER(FUNC, type, field)					\
		        LUA_FUNCTION(FUNC) { LUA->Check##type(1); field = LUA->Get##type(1); return 0; }
        ...
        #define LUA_FUNCTION_BSETTER(FUNC, field)					\
		        LUA_FUNCTION(FUNC) { LUA->CheckType(1, GarrysMod::Lua::Type::Bool); field = LUA->GetBool(1); return 0; }
